           ...
           <table class="table table-striped table-bordered">
                ...
                <tbody>
                 <tr v-for="(product, i) in product_list_arr" :key="i">
                    ...
                    <td style="vertical-align:middle;text-align: right;"><input class="form-control" style="border:none;background:transparent;text-align: right;" type="number" v-model="product.item_quantity"></td>
    ...
    updateInvoice(){
      ...
      console.log(this.product_list_arr_orginal);
       var post_data = {
        ...
        info:this.product_list_arr,
      };
      axios.post(this.BASE_URL+"api/purchase_invoice_update",post_data)
        .then(({ data }) => {
